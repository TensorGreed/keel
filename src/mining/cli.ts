...
Usage: keel mine [--model ollama|anthropic] [--limit N]
...
The model name is KEEL_MINER_MODEL (default llama3.2 for ollama, claude-haiku-4-5 for
anthropic); Ollama's base URL is KEEL_OLLAMA_URL (default http://localhost:11434).
Run 'keel ingest' first to populate PR threads. Safe to re-run — already-mined PRs are skipped.`;
